...
```
where:
- `A` can be any positive number. For this implementation we chose the golden ratio $\frac{\sqrt{5} - 1}{2}$ since it has been shown in the literature that it works quite well for the MHDA*.
